        ...
        <div>
            <div className='flex items-center justify-start h-[400px] xl:h-[500px] bg-no-repeat bg-cover bg-primary bg-grid'>
                <div className='container mt-20 text-white'>
                    <h1 className='max-w-7xl mb-6 lg:mb-12 text-4xl font-bold lg:text-[100px] lg:leading-[100px]'>Testimoni {testimoni[0].nama_jenis_mbkm}</h1>
            ...
            <div className="container py-10">
                ...
                <div>
                    ...
                    <div className="grid gap-8 py-10">
                        <div className="bg-[#FFE601] bg-opacity-75 px-6 py-4 lg:px-12 lg:py-7 rounded-xl lg:rounded-3xl testimoni-card-odd">
                        ...
                        <div className="bg-[#FF9B00] bg-opacity-75 px-6 py-4 lg:px-12 lg:py-7 rounded-xl lg:rounded-3xl testimoni-card-even">
