            ...
            <div className="grid gap-y-1 lg:gap-0 col-span-2 text-justify">
                ...
                <div className="flex gap-3 items-center mt-4">
                    <div className="flex justify-center items-center">
                        <Image className="lg:w-[40px] lg:h-[40px]" src={'/polygon.svg'} width={25} height={25} alt='' />
                        <Image className="absolute lg:w-[20px] lg:h-[20px]" src={'/landmark-solid.svg'} width={13} height={13} alt='' />
                    </div>
