        ...
        <div className="mt-[40px] mb-[40px] ml-[60px] mr-[60px]">
            <div className="grid gap-y-1 lg:gap-0 col-span-2 text-justify">
                ...
                <div className="flex gap-3 items-center mt-4">
                    ...
                    <p className="lg:text-[21px] text-[15px] font-medium leading-8">Repository Skripsi, <Link target="_blank" href={props.link} className="lg:text-[21px] text-gradient underline decoration-red-400 hover:decoration-red-600">Klik Disini! </Link></p>
                </div>
            </div>
        </div>
    )
